...
<template>
    <form class="row g-3 p-3 d-none" data-show-form>
        <div class="col-md-6">
            <label for="first_name" class="form-label">{{ lang['personal_first_name'] }}</label>
            <input type="text" class="form-control" id="first_name" name="first_name" data-form-main>
        </div>

        <div class="col-md-6">
            <label for="last_name" class="form-label">{{ lang['personal_last_name'] }}</label>
        ...
        <div class="col-md-4">
            ...
            <select class="form-select" name="age" aria-label="age" id="age" data-form-main>
                <option value="adult">{{ lang['adult'] }}</option>
                <option value="kid">{{ lang['kid'] }}</option>
            </select>
        </div>

        <div class="col-md-3">
            <label for="book_id" class="form-label">{{ lang['bookingId'] }}</label>
