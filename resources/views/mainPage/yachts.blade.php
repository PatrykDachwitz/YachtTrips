<div class="slidersContainer bg-gray py-5">
    <h2 class="d-flex w-100 justify-content-center pb-4 d-xxl-none"><b>Dlaczego Wybrać Nasze Wycieczki?</b></h2>

    <div class="customSizeImg m-0 p-0 d-flex justify-content-center justify-content-lg-end align-items-center overflow-hidden">
    ...
    <div class="customSize m-0 px-5 px-xxl-0 ps-xxl-5 pe-xxl-0 pt-5 pt-xxl-0 d-flex flex-column align-items-end justify-content-center align-items-xxl-start">
        <div class="d-flex">
            <div class="me-3 d-flex align-items-center">
                <div>
                    <button class="btn btn-dark fs-3">
                        <bold><</bold>
                    </button>
                </div>
            </div>
