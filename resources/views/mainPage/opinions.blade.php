<div class="w-100 m-0 mt-2 mb-5 d-flex justify-content-center">
    <div style="max-width: 1920px" class="m-0 g-4 row mt-2 mb-5">

        @if(!empty($content->name))
            <h2 class="text-center mt-3 fs-3 mb-2"><b>{{ $content->name }}</b></h2>
        @endempty
                ...
                <div class="d-flex border-grayLight-1 shadow-sm p-3 rounded-2 overflow-hidden h-100 bg-gray">
                    ...
                    <div class="d-flex flex-column justify-content-start">
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            @endfor
                            <span class="fs-5 ms-2 pt-1">5/5</span>
                        </div>
                    </div>
                </div>
            </div>
