    ...
    <div class="supportNavigation d-flex justify-content-lg-center flex-column flex-lg-row py-4 align-items-center align-items-lg-start container-1920">
        ...
        <div class="d-flex flex-column mx-lg-5">
            ...
            <ul class="colorGray list-unstyled fs-5 d-none d-lg-block">
                <li><a class="text-decoration-none colorGray" href="{{ route('pages', [ "id" => 2]) }}">@lang('footer.privacyPolicy')</a></li>
                <li><a class="text-decoration-none colorGray" href="{{ route('pages', [ "id" => 1]) }}">@lang('footer.statute')</a></li>
                <li><a class="text-decoration-none colorGray" href="{{ route('pages', [ "id" => 3]) }}">@lang('footer.contact')</a></li>
            </ul>
        </div>
