<footer class="footer bg-dark d-flex flex-column text-white shadow">
    <div class="supportNavigation d-flex justify-content-lg-evenly flex-column flex-lg-row py-4 align-items-center align-items-lg-start w-75">
        <div class=" d-flex flex-column align-items-center align-items-lg-start">
            ...
            <div class="d-flex flex-row flex-lg-column me-5 me-lg-0">
                <div class=" d-flex flex-column">
                    ...
                    <span class="fs-6">ul. warszawska 23, Warszawska</span>
                    <span class="fs-6 ">64-200 Warszawa</span>
                </div>
                <hr class="w-50 d-none d-lg-block"/>
                <div class=" d-flex flex-column ms-5 ms-lg-0">
                    <span class="fs-6 mb-1">NIP: 123-123-123</span>

                    <span class="fs-6 mb-1">Tel. +48 123 123 123</span>

                    <span class="fs-6">E-mail: hello@artforma.com</span>
                </div>
        ...
        <div class="d-flex flex-column">
            <h3 class="fs-5">Obsługa klienta</h3>
            <ul class="colorGray list-unstyled fs-6 d-none d-lg-block">
