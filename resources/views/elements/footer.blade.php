<footer class="footer footer-bottom bg-dark text-white shadow d-flex justify-content-center py-1">
    ...
    <div class="d-flex flex-column  flex-md-row py-2 fs-6  justify-content-center justify-content-lg-around colorGray w-100" style="max-width: 1920px">
        <span class="text-center mb-1 mb-lg-0">© Copyright 2023 <b>@lang('menu.nameCompany')</b></span>

        <ul class="colorGray list-unstyled fs-5 d-flex m-0">
...
<!--
<div class="supportNavigation d-flex justify-content-lg-center flex-column flex-lg-row py-4 align-items-center align-items-lg-start container-1920 d-none">
